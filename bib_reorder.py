def bib_writer(ref_init,file_lines,path_to_file=None,name_of_file=None,ref_list=None,unordered_bib=None,read_write=None):
    ...
    if ref_init == True:
        ...
        for linenum, line in enumerate(file_lines):
            ...
            if "!!ref_start" in line: #start looking for refs after !!ref_start
                ...
                if bib_start == 1 and line.startswith("\n") == False:
                    pass
                else:
                    continue
        ...
        return unordered_bib,bib_start
